                    ...
                    <div style="padding-top:30px" class="panel-body"  >
                        ...
                        <form id="loginform" class="form-horizontal" role="form">
                            ...
                            <div style="margin-bottom: 25px" class="input-group">
                                        ...
                                        <input [(ngModel)]="user" id="login-username" type="text" class="form-control" name="username" placeholder="Nome de utilizador">                                        
                                    </div>
                                
                            <div style="margin-bottom: 25px" class="input-group">
                                        <span class="input-group-addon"><i class="pe-7s-lock"></i></span>
                                        <input [(ngModel)]="password" id="login-password" type="password" class="form-control" name="password" placeholder="Password">
                                    </div>
